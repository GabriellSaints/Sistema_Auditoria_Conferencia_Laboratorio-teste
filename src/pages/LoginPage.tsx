...
import { UserCircle2, Lock, ShieldAlert, KeyRound, Loader2 } from "lucide-react";
      ...
      <div className="w-full max-w-md bg-white dark:bg-slate-900 rounded-3xl shadow-xl border border-slate-100 dark:border-slate-800 overflow-hidden relative">
        ...
        <div className="p-10 pt-12">
            <div className="flex flex-col items-center justify-center mb-8">
                ...
                <p className="text-slate-500 dark:text-slate-400 text-sm font-medium mt-1 text-center">Geração de relatórios de auditoria</p>
            </div>
