          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="relative z-10 space-y-6">
                    ...
                    <h3 className="text-2xl font-bold font-headline mt-1 uppercase">
                        {displayAuditor.name}
                    </h3>
                    <p className="text-sm text-white/80 font-medium">{displayAuditor.score} pontos consolidados</p>
                    <div className="mt-6 p-4 bg-white/5 rounded-2xl space-y-2.5 backdrop-blur-md border border-white/5">
                        <p className="flex justify-between text-[11px] font-bold text-white/90">
                ...
                <div className="md:col-span-2 bg-white dark:bg-slate-800 p-8 rounded-3xl shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-700 flex flex-col max-h-[500px]">
                <div className="flex justify-between items-center mb-6">
                    <h3 className="text-xl font-bold text-primary dark:text-indigo-400 font-headline">
                    Placar de Auditores
                    </h3>
                </div>
                ...
                <div className="space-y-3 overflow-y-auto pr-2 custom-scrollbar flex-1">
                    {ranking.map((leader) => {
                        ...
                        <div
                            ...
                            className={cn(
                                "flex items-center justify-between p-4 rounded-2xl transition-all duration-300 group bg-white dark:bg-slate-800 relative overflow-hidden cursor-pointer border",
                                isSelected 
                                   ? "border-indigo-500 shadow-md shadow-indigo-500/10 bg-indigo-50/40 dark:bg-indigo-900/30 ring-1 ring-indigo-500 z-10" 
                                   : "border-slate-100 dark:border-slate-700 hover:border-indigo-200 dark:hover:border-indigo-500 hover:shadow-sm"
                            )}
                        >
                        ...
                        <div className="min-w-0 pr-4">
                            ...
                            <p className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-widest truncate">
                            {leader.level}
                            </p>
                        </div>
                        </div>
                        ...
                        <div className="text-right">
                            <p className="text-base font-black text-primary font-headline leading-none mb-1">
                            {leader.score}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <h3 className="text-xl font-bold text-primary dark:text-indigo-400 font-headline mb-6 flex items-center gap-2">
                    <Medal className="w-6 h-6 text-primary dark:text-indigo-400" /> Regras de Pontuação
                </h3>
                <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 rounded-xl bg-slate-50 dark:bg-slate-700/50 border border-slate-100 dark:border-slate-600">
                    <div className="flex items-center gap-3">
                        <div className="w-2 h-2 rounded-full bg-slate-400"></div>
                        <span className="text-sm font-bold text-slate-700 dark:text-slate-200">Base</span>
                    </div>
                    <span className="text-sm font-black text-slate-500 dark:text-slate-400">1000 pts</span>
                    </div>
                ...
                <div className="bg-slate-50 dark:bg-slate-800/80 relative overflow-hidden p-8 rounded-3xl border border-slate-200 dark:border-slate-700 flex flex-col items-center justify-center text-center space-y-6 shadow-inner">
                ...
                <h3 className="text-2xl font-black text-primary dark:text-white font-headline tracking-tight">
                    Níveis Operacionais
                </h3>
                <p className="text-sm text-slate-600 dark:text-slate-300 font-medium max-w-sm leading-relaxed">
